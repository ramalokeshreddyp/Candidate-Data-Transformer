...
together the pieces in schema.py, extractors.py, merge.py, project.py and
validate.py. If you're reviewing this code top-down, this is the file that
tells the story; everything else is detail.
"""
...
from validate import validate_default_schema, validate_custom_projection
